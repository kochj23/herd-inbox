"""Test suite for herd_inbox.security — drives the implementation via TDD.
...
from herd_inbox.security import (
    CSP_HEADER_VALUE,
    SanitizationError,
    audit,
...
def test_link_safety_callback_directly_drops_bad_protocol():
    ...
    from herd_inbox.security import _link_safety_callback
...
def test_sanitize_short_field_caps_length():
    ...
    from herd_inbox.security import MAX_SUBJECT_CHARS, MAX_TLDR_CHARS, sanitize_short_field
